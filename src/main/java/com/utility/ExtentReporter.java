...
//		System.out.println("platform Name" + context.getCurrentXmlTest().getSuite().getName());
		String platformName = context.getCurrentXmlTest().getSuite().getName();
...
//		System.out.println("browser name " + testContext.getCurrentXmlTest().getParameter("browserType"));
